...
<div class="row">
	<div class="col-xs-12">
		...
		<form method="post" id="form_data" name="form_data"	 action="User_updatePassword"  	class="well form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="name">旧密码：</label>
				<div class="col-sm-10">
					<input class="form-control"  type="text" id="password"  name="user.password" >
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" id="phone" name="password" >
				</div>
			</div>
			
		
			<div class="form-group">
				<label class="col-sm-2 control-label" for="name">重复新密码：</label>
				<div class="col-sm-10">
					<input class="form-control" type="text" id="email" name="passwords" >
				</div>
			</div>
