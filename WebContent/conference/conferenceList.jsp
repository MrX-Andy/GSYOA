...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="ul_table">
			<ul>
				<li class="thead">
					<span class="col-35"> 会议主题</span>
					<span class="col-10"> 部门经理</span> 
					<span class="col-20"> 会议时间</span>
					<span class="col-15"> 会议地点</span>
					<s:if test="#session.UserPosition.id!=1"><span class="col-30 pull-right text-center">操作</span>   </s:if>
					
				</li>
				
				<s:iterator value="#request.cfList" id="cfList">
				<form method="post" action="###Conference_delete" name="form_data" id="form_data">
					<li class="tbody normal">
						<span class="col-35"> 
							<a href="###Conference_show?conference.id=<s:property value="#cfList.id"/>"><s:property value="#cfList.title"/></a>
						</span> 
						<span class="col-10"> 
							<s:property value="#cfList.createUserId.name"/>
						</span> 
						<span class="col-20"> 
							<s:property value="#cfList.createTime"/>
						</span> 
						<span class="col-15"> 
							<s:property value="#cfList.address"/>
						</span> 
						<s:if test="#session.UserPosition.id!=1">
						<span class="col-30 pull-right text-center">
							<a href="#W#Conference_delete?conference.id=<s:property value="#cfList.id"/>" class="btn btn-primary btn-xs ">删除</a>　
