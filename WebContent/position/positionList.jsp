				...
				<form method="post" action="###Department_delete" name="form_data" id="form_data">
					<li class="tbody normal">
						...
						<span class="col-15 pull-right text-center">
							<a href="#W#Position_delete?position.id=<s:property value="#position.id"/>" class="btn btn-primary btn-xs ">删除</a>　
							<a href="###Position_update?position.id=<s:property value="#position.id"/>" class="btn btn-primary btn-xs ">修改</a>
						</span>
